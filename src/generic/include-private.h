#ifndef mulle_objc_time_foundation_include_private_h__
#define mulle_objc_time_foundation_include_private_h__
 ...
 */
#include "_MulleObjCTimeFoundation-include-private.h"
