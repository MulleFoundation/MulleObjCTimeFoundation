...
#
# MulleObjC-startup nodetype: ${MULLE_OBJC_STARTUP_NODETYPE:-tar}
#
export MULLE_OBJC_STARTUP_NODETYPE="git"


#
# MulleObjC-startup url: ${MULLE_OBJC_STARTUP_URL:-https://github.com/MulleFoundation/MulleObjC-startup/archive/${MULLE_TAG}.tar.gz}
#
export MULLE_OBJC_STARTUP_URL="https://github.com/MulleFoundation/MulleObjC-startup.git"
